                                ...
                                <div className="space-y-2">
                                   ...
                                   <div className="bg-white p-2 rounded-lg border border-indigo-100 flex flex-col gap-2">
                                      <div className="flex justify-between items-center px-1">
                                         <span className="text-[8px] font-black text-indigo-400 uppercase">PARCELAS (1-5X)</span>
                                         <div className="flex items-center gap-2">
                                            <button type="button" onClick={() => setInstallments(Math.max(1, installments - 1))} className="p-1 bg-indigo-50 text-indigo-600 rounded">
                                               <ChevronLeft size={10} />
                                            </button>
